...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "epurchase@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "epurchase API";

        private String description = "epurchase API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "epurchase";
